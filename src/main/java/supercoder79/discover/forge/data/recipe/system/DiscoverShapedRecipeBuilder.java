...
public class DiscoverShapedRecipeBuilder implements RecipeBuilder {
   ...
   public DiscoverShapedRecipeBuilder(@Nullable String name, ItemLike p_126114_, int p_126115_) {
      this.name = name;
      this.result = p_126114_.asItem();
      this.count = p_126115_;
   }

   public static DiscoverShapedRecipeBuilder shaped(ItemLike p_126117_) {
      return shaped(p_126117_, 1);
   }

   public static DiscoverShapedRecipeBuilder shaped(ItemLike p_126119_, int p_126120_) {
      return new DiscoverShapedRecipeBuilder(null, p_126119_, p_126120_);
   }

   public static DiscoverShapedRecipeBuilder shaped(String name, ItemLike p_126119_, int p_126120_) {
      return new DiscoverShapedRecipeBuilder(name, p_126119_, p_126120_);
   }

   public DiscoverShapedRecipeBuilder define(Character p_206417_, TagKey<Item> p_206418_) {
      return this.define(p_206417_, Ingredient.of(p_206418_));
   }

   public DiscoverShapedRecipeBuilder define(Character p_126128_, ItemLike p_126129_) {
      return this.define(p_126128_, Ingredient.of(p_126129_));
   }

   public DiscoverShapedRecipeBuilder define(Character p_126125_, Ingredient p_126126_) {
   ...
   public DiscoverShapedRecipeBuilder pattern(String p_126131_) {
   ...
   public DiscoverShapedRecipeBuilder unlockedBy(String p_126133_, CriterionTriggerInstance p_126134_) {
      this.advancement.addCriterion(p_126133_, p_126134_);
      return this;
   }

   public DiscoverShapedRecipeBuilder group(@Nullable String p_126146_) {
   ...
   public void save(Consumer<FinishedRecipe> p_176499_) {
      this.save(p_176499_, name == null ? RecipeBuilder.getDefaultRecipeId(this.getResult()) : Discover.id(name));
   }
   ...
   public void save(Consumer<FinishedRecipe> p_126141_, ResourceLocation p_126142_) {
      ...
      p_126141_.accept(new DiscoverShapedRecipeBuilder.Result(p_126142_,
              this.result,
              this.count,
              ...
              this.key,
              this.advancement,
              // TODO: fix recipe folder
              new ResourceLocation(p_126142_.getNamespace(), "recipes/" + this.result.getItemCategory().getRecipeFolderName() + "/" + p_126142_.getPath())));
   }
